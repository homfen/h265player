...
class ProgressBar extends BaseComponent {
  ...
  initProps() {
    ...
    const cssName = this.options.cssName;
    this.$progressDragDot = $progressBar.querySelector(
      "." + cssName.progressBarDot
    );
    this.$progressBarPlay = $progressBar.querySelector(
      "." + cssName.progressBarPlay
    );
    this.$progressBarLoad = $progressBar.querySelector(
      "." + cssName.progressBarLoad
    );
  ...
  bindEvent() {
    ...
    delegator(this.options.$controlBarContainer).on(
      "click",
      "." + cssName.progressBar,
      (evt) => {
    ...
    this.progressDragEvent = dragger(this.$progressDragDot, {
      ...
      scope: {
        ...
        bottom:
          this.$progressDragDot.offsetTop + this.$progressDragDot.offsetHeight
      },
      onStart: () => {
        isDraging = true;
